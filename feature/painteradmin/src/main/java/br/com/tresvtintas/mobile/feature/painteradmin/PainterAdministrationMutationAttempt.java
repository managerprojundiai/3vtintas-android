...
final class PainterAdministrationMutationAttempt {
    ...
    static PainterAdministrationMutationAttempt restored(
            String key,
            String fingerprint) {
        PainterAdministrationMutationAttempt result =
    ...
    String keyFor(String canonicalPayload) {
        if (canonicalPayload == null || canonicalPayload.isEmpty()) {
            throw new IllegalArgumentException(
                    "Painter administration attempt is invalid.");
        }
